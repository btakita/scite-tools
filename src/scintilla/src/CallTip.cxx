...
CallTip::CallTip() {
  ...
  // modified by Mitchell
	colourBG.desired = ColourDesired(0x44, 0x44, 0x44);
	colourUnSel.desired = ColourDesired(0xAA, 0xAA, 0xAA);
	colourSel.desired = ColourDesired(0x66, 0x99, 0xFF);
	colourShade.desired = ColourDesired(0x66, 0x66, 0x66);
	colourLight.desired = ColourDesired(0x66, 0x66, 0x66);
