...
// added by Mitchell
#ifdef USELPEGLEX
void LexerModule::Init(lua_State *L, const char *languageName, Accessor &styler) const {
	if (fnInit)
		fnInit(L, languageName, styler);
}
#endif
// end added by Mitchell
...
void LexerModule::Lex(unsigned int startPos, int lengthDoc, int initStyle,
	...
	if (fnLexer)
		fnLexer(startPos, lengthDoc, initStyle, L, keywordlists, styler);
}
...
void LexerModule::Fold(unsigned int startPos, int lengthDoc, int initStyle,
	...
	if (fnFolder) {
		...
		fnFolder(startPos, lengthDoc, initStyle, L, keywordlists, styler);
	}
}
