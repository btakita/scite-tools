...
static int cf_scite_switch_buffer(lua_State *L) {
	host->SwitchToBuffer(luaL_checkint(L, 1));
	return 0;
}
...
static bool InitGlobalScope(bool checkProperties, bool forceReload = false) {
	...
	// added by Mitchell
	// popup an input box with custom title, label, and default text args
	// (output is captured with	OnInput)
