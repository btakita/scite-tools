...
void SciTEBase::SetAboutMessage(WindowID wsci, const char *appTitle) {
	if (wsci) {
		...
		AddStyledText(wsci, "December 1998-August 2006.\n", 3);
...
void SciTEBase::StartRecordMacro() {
	...
	if (extender) // added by Mitchell
		extender->OnMacro("macro:startrecord", ""); // added by Mitchell
}
...
void SciTEBase::SwitchToBuffer(int index) {
	SetDocumentAt(index);
}
